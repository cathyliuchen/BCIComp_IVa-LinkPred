...
train_data_save_path = 'data/dataset/aa/rt_hand_train_data.npy'
train_label_save_path = 'data/dataset/aa/rt_hand_train_label.npy'
...
torch.save(generator, 'data/result/aa/rt_hand_train_data_generator.pkl')
